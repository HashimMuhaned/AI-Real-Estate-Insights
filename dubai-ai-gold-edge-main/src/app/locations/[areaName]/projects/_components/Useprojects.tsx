...
export function useAreaProjects(areaSlug: string) {
  ...
  // ─── Core fetch: reset + reload when appliedFilters or areaSlug change ────
  useEffect(() => {
  ...
  }, [appliedFilters, areaSlug, offset, hasMore, isFetchingMore]);
