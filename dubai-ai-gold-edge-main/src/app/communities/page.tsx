  ...
  const filtered = communities
    .filter((c) => {
      ...
      if (priceRange === "under1m") matchesPrice = minPrice < 1000000;
        ...
        matchesPrice = minPrice >= 1000000 && minPrice < 3000000;
      else if (priceRange === "3m-5m")
        matchesPrice = minPrice >= 3000000 && minPrice < 5000000;
      else if (priceRange === "over5m") matchesPrice = minPrice >= 5000000;

      let matchesPropertyType = true;
      if (propertyType !== "all") {
        matchesPropertyType = c.avg_prices?.some(
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-primary-foreground">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-6">
              Explore Dubai's Promising Communities
            </h1>
            ...
            {loading ? (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                {filtered.map((c) => (
                  <div
                    key={c.id}
                    className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 rounded-xl border overflow-hidden flex flex-col bg-card"
                  >
                    {/* IMAGE */}
                    ...
                    <div className="p-6 flex flex-col flex-1">
                              ...
                              <div className="mb-4 space-y-1 cursor-pointer">
                                ...
                                {c.avg_prices.length > 2 && (
                                  <p className="text-xs text-muted-foreground">
                                    +{c.avg_prices.length - 2} more property
                                    types
                                  </p>
                                )}
                              </div>
                      ...
                      <div className="flex gap-3 mt-auto">
                        <button className="flex-1 text-center rounded-lg bg-primary text-primary-foreground py-2.5 text-sm font-medium hover:bg-primary/90 transition-all">
                          Explore Community
                        </button>
            ...
            <div className="p-6 flex-1 overflow-y-auto">
              <div className="space-y-4">
                <p className="text-muted-foreground">
                  Describe what kind of community you're looking for, and I'll
